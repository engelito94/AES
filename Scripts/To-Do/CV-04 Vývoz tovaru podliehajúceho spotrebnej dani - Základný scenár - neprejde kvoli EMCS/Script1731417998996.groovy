...
if (datumPrijatia.isEmpty() || !(stavCV.equals('Prijaté'))) {
	log.logFailed('Operácie v hornej časti záznamu nie sú podľa očakávania' + stavCV)
...
filePath = (GlobalVariable.cestaSubor + 'CV-04_02_SK507_EMCS.xml')
...
if (stavAER.equals("Tovar predložený")) {
	...
	log.logFailed("Stav AER nie je Tovar predložený")
	util.markFailedAndStop("Predošlý krok zlyhal")
}
...
if (stavAER.equals("Tovar uvoľnený na okamžitý výstup")) {
	...
	log.logFailed("Stav AER nie je Tovar uvoľnený na okamžitý výstup")
	util.markFailedAndStop("Predošlý krok zlyhal")
}
...
//cesta k suboru na disku
filePath = (GlobalVariable.cestaSubor + 'CV-04_03_SK590_EMCS.xml')
...
if (stavAER.equals("Vyvezené")) {
	...
	log.logFailed("Stav AER nie je Vyvezené")
	util.markFailedAndStop("Posledný krok zlyhal")
}
...
if (!(stavCV.equals('Výstup potvrdený'))) {
	log.logFailed('Operácie v hornej časti záznamu nie sú podľa očakávania')
	util.markFailedAndStop("Stav CV je iný " +stavCV)
}
