...
'CEP'
Windows.startApplicationWithTitle('C:\\Program Files (x86)\\Ditec\\Ditec.Cep.Ekr.Interface\\Cep.Ekr.App.exe', 'CEP')
...
Windows.startApplicationWithTitle('C:\\Users\\barcik\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\CIS klient(DTC_TEST).lnk', 
    'CIS')
