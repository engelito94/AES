...
String filePath = GlobalVariable.cestaSubor + 'CV-11 Podanie eCV pred predložením tovaru (CV typu D) + žiadosť o opravu (SK513) pred  podaním oznámenia o predložení tovaru (SK511) - SK515 - DT-inTP.xml'
...
filePath = (GlobalVariable.cestaSubor + 'CV-11 Podanie eCV pred predložením tovaru (CV typu D) + žiadosť o opravu (SK513) pred  podaním oznámenia o predložení tovaru (SK511) - SK513 - DT-inTP.xml')
...
//cesta k suboru na disku
filePath = (GlobalVariable.cestaSubor + 'CV-11 Podanie eCV pred predložením tovaru (CV typu D) + žiadosť o opravu (SK513) pred  podaním oznámenia o predložení tovaru (SK511) - SK511 - DT-inTP.xml')
