...
String filePath = GlobalVariable.cestaSubor + 'OPP01_SK515.xml'
...
filePath = (GlobalVariable.cestaSubor + 'OPP09_SK513.xml')
...
Windows.click(findWindowsObject('Object Repository/CIS_klient/OPP/TabItem_ERP'))

Windows.click(findWindowsObject('Object Repository/CIS_klient/OPP/TabItem_ERP_NovyZaznam'))

Windows.doubleClick(findWindowsObject('Object Repository/CIS_klient/CU_Podania/Edit_VysledokKontroly'))

Windows.sendKeys(findWindowsObject('Object Repository/CIS_klient/CU_Podania/Edit_VysledokKontroly'), 'z')
...
Windows.setText(findWindowsObject('Object Repository/CIS_klient/CU_Podania/Edit_NalezKontrolyAER'), 'test zamietnutia ERP')

Windows.click(findWindowsObject('CIS_klient/CU_vyvozu/VyhladaneCV/PotvrditZrusenieFinal'))

'Podpis SK560AES'
if (Windows.verifyElementPresent(findWindowsObject('Object Repository/CIS_klient/CU_vyvozu/VyhladaneCV/Button_SpustitPodpisovanie'), 15, FailureHandling.OPTIONAL)) {
	...
	log.logInfo('SK560 Podpis OK')
}

Windows.delay(30)

Windows.verifyElementPresent(findWindowsObject('Object Repository/CIS_klient/CU_vystupu/Button__ZamietnutOPP'), 15)

Windows.doubleClick(findWindowsObject('Object Repository/CIS_klient/CU_vystupu/Button__ZamietnutOPP'))
