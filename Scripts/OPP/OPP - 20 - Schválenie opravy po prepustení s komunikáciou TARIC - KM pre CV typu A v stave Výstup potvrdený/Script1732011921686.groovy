...
filePath = (GlobalVariable.cestaSubor + 'OPP01_SK513.xml')
...
Windows.click(findWindowsObject('Object Repository/CIS_klient/CU_vystupu/Button__TaricOpatreniaOPP'))

String vysledok = Windows.getText(findWindowsObject('Object Repository/CIS_klient/CU_vystupu/Text_TaricKMVysledok'))

if (vysledok.equals("Výpočet skončil úspechom")) {
	log.logPassed("Výpočet OK")
} else {
	util.markFailedAndStop("Výpočet zlyhal")
}

Windows.click(findWindowsObject('Object Repository/CIS_klient/CU_vystupu/Zatvorit_KMTaric'))
