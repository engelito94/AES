...
Windows.verifyElementPresent(findWindowsObject('Object Repository/CIS_klient/CU_vystupu/Button__ZamietnutOPP'), 30)
Windows.click(findWindowsObject('Object Repository/CIS_klient/CU_vystupu/Button__ZamietnutOPP'))
