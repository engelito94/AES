...
String filePath = GlobalVariable.cestaSubor + 'PCV06 -  SK615EXS generuje CD601C a SK628EXS EXS.State =1 - ditec test.xml'
...
'Prepnutie na CEP - SK607'
filePath = GlobalVariable.cestaSubor + 'PCV06 - SK607EXS genr. CD502C a CD603C - ditec test.xml'
...
filePath = GlobalVariable.cestaSubor + 'PCV06 - SK590EXS  - nadväzuje na SK607EXS - ditec test.xml'
