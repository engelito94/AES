...
String filePath = GlobalVariable.cestaSubor + 'CV-06 Medzinárodné presmerovanie - Akceptované - SK515 - DT_inTP.xml'
...
filePath = (GlobalVariable.cestaSubor + 'CV-06 Medzinárodné presmerovanie - Akceptované - SK507 - DT_inTP.xml')
...
//cesta k suboru na disku
filePath = (GlobalVariable.cestaSubor + 'CV-06 Medzinárodné presmerovanie - Akceptované - SK590 - DT_inTP.xml')
...
if (datumPrijatia.isEmpty() || !(stavCV.equals('Výstup potvrdený'))) {
	log.logFailed('Operácie v hornej časti záznamu nie sú podľa očakávania. Stav CV je : ' + stavCV)
	util.markFailedAndStop("Operácie v hornej časti záznamu nie sú podľa očakávania.")
}
