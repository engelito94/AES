...
String filePath = GlobalVariable.cestaSubor + 'PCV01 - 1. SK615EXS - ePCV-01 Predbežný vývoz - Základný scenár - DTC.xml'
...
'Prepnutie na CEP'
filePath = GlobalVariable.cestaSubor + 'PCV01 - 2. SK613EXS - ePCV-01 Predbežný vývoz - Základný scenár - DTC.xml'
...
cep.prihlasCEP(GlobalVariable.menoCEP, GlobalVariable.hesloCEP)
cep.vyberXMLDialog(filePathDialog)
cep.vyplnSKSpravu(LRN, 'SK613EXS')
...
cep.otvorHistoriuZasielok()
cep.skontrolujPrijatuSpravu('SK604EXS', LRN)
...
'Prepnutie na CEP'
filePath = GlobalVariable.cestaSubor + 'PCV01 - 3. SK590EXS - ePCV-01 Predbežný vývoz - Základný scenár - DTC.xml'
