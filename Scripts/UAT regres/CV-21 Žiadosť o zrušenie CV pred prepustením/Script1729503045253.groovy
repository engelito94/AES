...
String filePath = GlobalVariable.cestaSubor + 'CV-21 Žiadosť o zrušenie CV pred prepustením - SK515 - DT-inTP.xml'
...
//cesta k suboru na disku
filePath = GlobalVariable.cestaSubor + 'CV-21 Žiadosť o zrušenie CV pred prepustením - SK514 - DT-inTP.xml'
...
if (!(stavCV.equals('Zrušené'))) {
	log.logFailed("Stav CV nie je zrušené")
} else {
	log.logPassed("Stav je Zrušené")
}
