...
String filePath = GlobalVariable.cestaSubor + 'CV-16 Vypršanie časovača pre dodatočné CV - SK515C - DT-inTP.xml'
...
Windows.click(findWindowsObject('Object Repository/CIS_klient/CU_vyvozu/VyhladaneCV/Button_ZmenitDatumLehoty'))

Windows.click(findWindowsObject('Object Repository/CIS_klient/CU_vyvozu/VyhladaneCV/PotvrditZrusenieFinal') // potvrdit predlzenie lehoty
    )

//Windows.getText(findWindowsObject('Object Repository/CIS_klient/CU_vyvozu/VyhladaneCV/Edit_DatumUkonceniaLehoty'))
Windows.click(findWindowsObject('Object Repository/CIS_klient/CU_vyvozu/VyhladaneCV/Edit_NovyDatumUkonceniaLehoty'))

Windows.setText(findWindowsObject('Object Repository/CIS_klient/CU_vyvozu/VyhladaneCV/Edit_NovyDatumUkonceniaLehoty'), '12.12.2026')

Windows.setText(findWindowsObject('Object Repository/CIS_klient/CU_vyvozu/VyhladaneCV/Edit_VyzvaNaPodanieDoplnkovehoCV'), 
    'test')
...
Windows.setText(findWindowsObject('Object Repository/CIS_klient/CU_vyvozu/VyhladaneCV/listItem_cisloPolozky'), '1')

Windows.setText(findWindowsObject('Object Repository/CIS_klient/CU_vyvozu/VyhladaneCV/Edit_TextInspekcnyZaznam'), 'test zmeny lehoty')
...
String inspekcnyZaznam = Windows.getText(findWindowsObject('Object Repository/CIS_klient/CU_vyvozu/VyhladaneCV/Text_TypInspekcnehoZaznamu'))

if (inspekcnyZaznam.equals("Predĺženie lehoty na podanie doplnkového CV")) {
	log.logInfo("Inšpekčný záznam vytvorený")
} else {
	util.markErrorAndStop("Inšpekčný záznam nie je vytvorený")
}
...
cep.skontrolujPrijatuSpravu('SK531AES', LRN)
...
Windows.setText(findWindowsObject('Object Repository/CIS_klient/CU_vyvozu/VyhladaneCV/Edit_NovyDatumUkonceniaLehoty'), '12.12.2027')
...
Windows.setText(findWindowsObject('Object Repository/CIS_klient/CU_vyvozu/VyhladaneCV/Edit_TextInspekcnyZaznam'), 'test zmeny lehoty1')
...
inspekcnyZaznam = Windows.getText(findWindowsObject('Object Repository/CIS_klient/CU_vyvozu/VyhladaneCV/Text_TypInspekcnehoZaznamu'))
