...
String filePath = GlobalVariable.cestaSubor + 'Y-02 SK515 - čiastkové  CV_TYP_C_VZOR.xml'
...
if (datumPrijatia.isEmpty() || !(stavCV.equals('Prijaté')) || !(upozornenia.contains('Čiastkové CV k súhrnnému CV.'))) {
