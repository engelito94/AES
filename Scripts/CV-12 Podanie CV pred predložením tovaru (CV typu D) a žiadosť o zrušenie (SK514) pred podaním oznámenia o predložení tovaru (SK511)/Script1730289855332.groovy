...
String filePath = GlobalVariable.cestaSubor + 'CV-12 Podanie eCV pred predložením tovaru (CV typu D) + žiadosť o zrušenie (SK514) pred podaním oznámenia o predložení tovaru (SK511) - SK515 - DT-inTP.xml'
...
filePath = (GlobalVariable.cestaSubor + 'CV-12 Podanie eCV pred predložením tovaru (CV typu D) + žiadosť o zrušenie (SK514) pred podaním oznámenia o predložení tovaru (SK511) - SK514 - DT-inTP.xml')
